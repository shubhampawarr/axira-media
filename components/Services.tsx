...
const services = [
  ...
  },
  {
    ...
    icon: MapPin,
    desc: 'Local SEO and Google Maps visibility optimization.',
  },
];

export default function Services() {
  return (
    <section id="services" className="py-24 px-6 bg-[#f8fbff]">
        ...
        <FadeUp>
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="section-text max-w-2xl mx-auto mt-5">
              From social media and paid advertising to SEO, websites,
              branding and local visibility.
            </p>
          </div>
        </FadeUp>
          ...
          {services.map((service, index) => {
            ...
            return (
              <FadeUp key={service.title} delay={index * 0.08}>
                <div className="premium-card p-4 md:p-8 h-full">
                  ...
                  <h3 className="text-base md:text-2xl font-bold mb-2 md:mb-4 text-[#071a3d] leading-tight">
                    {service.title}
                  </h3>
